...
import { storeData } from '../../formData';
...
class EditStoreForm extends Component {
	...
	handleSave() {
		this.props.handleFormSave(
			{
				uniqueNo: this.storeId.getValue(),
						...
						<Form className="form-horizontal mt-5">
							<div style={{ "height": "65vh" }} >
								...
								<div className="form-actions mt-5 mb-5">
									...
									<Button size="lg" disabled={!this.state.value} onClick={this.handleSave} className="ml-1 mt-1 mb-1 bg-lightgreen">Create</Button>
								</div>
							</div>
						</Form>
					</CardBody>
